...
proof -
  obtain s::name and k::name and l::name and sl::name and m::name and n::name and sm::name and sn::name
    where atoms:
      "atom s \<sharp> (k,l,sl,m,n,sm,sn)"
      "atom k \<sharp> (l,sl,m,n,sm,sn)"
      "atom l \<sharp> (sl,m,n,sm,sn)"
      "atom sl \<sharp> (m,n,sm,sn)"
      "atom m \<sharp> (n,sm,sn)"
      "atom n \<sharp> (sm,sn)"
      "atom sm \<sharp> sn"
    by (metis obtain_fresh)
  then show ?thesis
...
lemma TermP_Zero: "{} \<turnstile> TermP Zero"
proof -
  obtain s::name and k::name and l::name and sl::name and m::name and n::name and sm::name and sn::name
    where atoms:
      "atom s \<sharp> (k,l,sl,m,n,sm,sn)"
...
proof -
  obtain s::name and k::name and l::name and sl::name and m::name and n::name and sm::name and sn::name
    where atoms:
      "atom s \<sharp> (k,l,sl,m,n,sm,sn,x)"
      "atom k \<sharp> (l,sl,m,n,sm,sn,x)"
      "atom l \<sharp> (sl,m,n,sm,sn,x)"
      "atom sl \<sharp> (m,n,sm,sn,x)"
      "atom m \<sharp> (n,sm,sn,x)"
      "atom n \<sharp> (sm,sn,x)"
      "atom sm \<sharp> (sn,x)"
      "atom sn \<sharp> x"
    by (metis obtain_fresh)
  then show ?thesis
...
lemma SeqTermP_Eats:
  assumes "atom s \<sharp> (k,s1,s2,k1,k2,t1,t2)" "atom k \<sharp> (s1,s2,k1,k2,t1,t2)"
    shows "{SeqTermP s1 k1 t1, SeqTermP s2 k2 t2}
           \<turnstile> Ex s (Ex k (SeqTermP (Var s) (Var k) (Q_Eats t1 t2)))" (*<*)
proof -
  obtain km::name and kn::name and j::name and k'::name 
     and l::name and sl::name and m::name and n::name and sm::name and sn::name
    where atoms:
...
theorem TermP_Eats: "{TermP t1, TermP t2} \<turnstile> TermP (Q_Eats t1 t2)"
proof -
  obtain k1::name and s1::name and k2::name and s2::name and k::name and s::name
    where "atom s1 \<sharp> (t1,t2)" "atom k1 \<sharp> (t1,t2,s1)"  
      "atom s2 \<sharp> (t1,t2,k1,s1)" "atom k2 \<sharp> (t1,t2,s2,k1,s1)"
...
lemma TermP_quot_dbtm:
  fixes \<alpha> :: tm
  assumes "wf_dbtm u"
  shows "{} \<turnstile> TermP (quot_dbtm u)"
  using assms
...
lemma SeqAbstFormP_Mem:
  ...
  shows "{AbstTermP v i x x', AbstTermP v i y y'} 
           \<turnstile> Ex s (Ex k (SeqAbstFormP v i (Q_Mem x y) (Q_Mem x' y') (Var s) (Var k)))"
proof -
  let ?vs = "(s,k,x,y,x',y',v,i)"
  obtain l::name and sl::name and sl'::name and m::name and n::name and sm::name and sm'::name and sn::name and sn'::name
    and sli smi sni :: name
    where
      "atom sni \<sharp> (?vs,sl,sl',m,n,sm,sm',sn,sn',l,sli,smi)"
      "atom smi \<sharp> (?vs,sl,sl',m,n,sm,sm',sn,sn',l,sli)"
      "atom sli \<sharp> (?vs,sl,sl',m,n,sm,sm',sn,sn',l)"
      "atom l \<sharp> (?vs,sl,sl',m,n,sm,sm',sn,sn')"
      "atom sl \<sharp> (?vs,sl',m,n,sm,sm',sn,sn')" "atom sl' \<sharp> (?vs,m,n,sm,sm',sn,sn')"
      "atom m \<sharp> (?vs,n,sm,sm',sn,sn')" "atom n \<sharp> (?vs,sm,sm',sn,sn')"
      "atom sm \<sharp> (?vs,sm',sn,sn')" "atom sm' \<sharp> (?vs,sn,sn')"
...
lemma AbstFormP_Mem: 
  "{AbstTermP v i x x', AbstTermP v i y y'} \<turnstile> AbstFormP v i (Q_Mem x y) (Q_Mem x' y')"
proof -
  obtain k1::name and s1::name and k2::name and s2::name and k::name and s::name
    where "atom s1 \<sharp> (v,i,x,y,x',y')" "atom k1 \<sharp> (v,i,x,y,x',y',s1)"  
      "atom s2 \<sharp> (v,i,x,y,x',y',k1,s1)" "atom k2 \<sharp> (v,i,x,y,x',y',s2,k1,s1)"
...
lemma SeqAbstFormP_Eq:
  assumes sk: "atom s \<sharp> (k,x,y,x',y',v,i)" "atom k \<sharp> (x,y,x',y',v,i)"
  shows "{AbstTermP v i x x', AbstTermP v i y y'} 
           \<turnstile> Ex s (Ex k (SeqAbstFormP v i (Q_Eq x y) (Q_Eq x' y') (Var s) (Var k)))"
proof -
  let ?vs = "(s,k,x,y,x',y',v,i)"
  obtain l::name and sl::name and sl'::name and m::name and n::name and sm::name and sm'::name and sn::name and sn'::name
    and sli smi sni :: name
...
lemma AbstFormP_Eq: 
  "{AbstTermP v i x x', AbstTermP v i y y'} \<turnstile> AbstFormP v i (Q_Eq x y) (Q_Eq x' y')"
proof -
  obtain k1::name and s1::name and k2::name and s2::name and k::name and s::name
    where "atom s1 \<sharp> (v,i,x,y,x',y')" "atom k1 \<sharp> (v,i,x,y,x',y',s1)"  
      "atom s2 \<sharp> (v,i,x,y,x',y',k1,s1)" "atom k2 \<sharp> (v,i,x,y,x',y',s2,k1,s1)"
...
lemma SeqAbstFormP_Neg:
  ...
  shows "{SeqAbstFormP v i x x' s1 k1, OrdP i, VarP v} 
           \<turnstile> Ex s (Ex k (SeqAbstFormP v i (Q_Neg x) (Q_Neg x') (Var s) (Var k)))" (*<*)
proof -
  let ?vs = "(s1,k1,s,k,x,x',v,i)"
  obtain l::name and sl::name and sl'::name and m::name and n::name and 
    sm::name and sm'::name and sn::name and sn'::name
  ...
  proof (rule All2_SUCC_I, simp_all)
    show "?hyp \<turnstile> SyntaxN.Ex sli (SyntaxN.Ex sl (SyntaxN.Ex sl'
  ...
  next
    show "?hyp \<turnstile> All2 l (SUCC k1) (SyntaxN.Ex sli (SyntaxN.Ex sl (SyntaxN.Ex sl'
...
theorem AbstFormP_Neg: "{AbstFormP v i x x'} \<turnstile> AbstFormP v i (Q_Neg x) (Q_Neg x')"
proof -
  obtain k1::name and s1::name and k::name and s::name
    where "atom s1 \<sharp> (v,i,x,x')"        "atom k1 \<sharp> (v,i,x,x',s1)"  
      "atom s  \<sharp> (v,i,x,x',k1,s1)"  "atom k  \<sharp> (v,i,x,x',s,k1,s1)" 
...
lemma SeqAbstFormP_Disj:
  ...
  shows "{SeqAbstFormP v i x x' s1 k1, 
           ...
           \<turnstile> Ex s (Ex k (SeqAbstFormP v i (Q_Disj x y) (Q_Disj x' y') (Var s) (Var k)))" (*<*)
proof -
  let ?vs = "(s1,s2,s,k1,k2,k,x,y,x',y',v,i)"
  obtain km::name and kn::name and j::name and k'::name 
    and l::name and sl::name and sl'::name and m::name and n::name  
    and sm::name and sm'::name and sn::name and sn'::name and sli sni smi :: name
    where atoms2: "atom km \<sharp> (kn,j,k',sni,smi,sli,l,s1,s2,s,k1,k2,k,x,y,x',y',v,i,sl,sl',m,n,sm,sm',sn,sn')"
      "atom kn \<sharp> (j,k',sni,smi,sli,l,s1,s2,s,k1,k2,k,x,y,x',y',v,i,sl,sl',m,n,sm,sm',sn,sn')"
      "atom j \<sharp> (k',sni,smi,sli,l,s1,s2,s,k1,k2,k,x,y,x',y',v,i,sl,sl',m,n,sm,sm',sn,sn')"
      and atoms: "atom k' \<sharp> (sni,smi,sli,l,s1,s2,s,k1,k2,k,x,y,x',y',v,i,sl,sl',m,n,sm,sm',sn,sn')"
      "atom sni \<sharp> (?vs,sl,sl',m,n,sm,sm',sn,sn',l,sli,smi)"
      "atom smi \<sharp> (?vs,sl,sl',m,n,sm,sm',sn,sn',l,sli)"
      "atom sli \<sharp> (?vs,sl,sl',m,n,sm,sm',sn,sn',l)"
      "atom l \<sharp> (s1,s2,s,k1,k2,k,x,y,x',y',v,i,sl,sl',m,n,sm,sm',sn,sn')"
...
theorem AbstFormP_Disj: 
  "{AbstFormP v i x x', AbstFormP v i y y'} \<turnstile> AbstFormP v i (Q_Disj x y) (Q_Disj x' y')"
proof -
  obtain k1::name and s1::name and k2::name and s2::name and k::name and s::name
    where "atom s1 \<sharp> (v,i,x,y,x',y')"        "atom k1 \<sharp> (v,i,x,y,x',y',s1)"  
      "atom s2 \<sharp> (v,i,x,y,x',y',k1,s1)"  "atom k2 \<sharp> (v,i,x,y,x',y',s2,k1,s1)"
...
lemma SeqAbstFormP_Ex:
  ...
  shows "{SeqAbstFormP v (SUCC i) x x' s1 k1, OrdP i, VarP v} 
           \<turnstile> Ex s (Ex k (SeqAbstFormP v i (Q_Ex x) (Q_Ex x') (Var s) (Var k)))" (*<*)
proof -
  obtain l::name and sl::name and sl'::name and m::name and n::name
    and sm::name and sm'::name and sn::name and sn'::name
    and sli smi sni :: name
    where atoms:
      "atom sni \<sharp> (s1,k1,s,k,x,x',v,i,sl,sl',m,n,sm,sm',sn,sn',l,sli,smi)"
      "atom smi \<sharp> (s1,k1,s,k,x,x',v,i,sl,sl',m,n,sm,sm',sn,sn',l,sli)"
      "atom sli \<sharp> (s1,k1,s,k,x,x',v,i,sl,sl',m,n,sm,sm',sn,sn',l)"
      "atom l \<sharp> (s1,k1,s,k,x,x',v,i,sl,sl',m,n,sm,sm',sn,sn')"
      "atom sl \<sharp> (s1,k1,s,k,x,x',v,i,sl',m,n,sm,sm',sn,sn')" 
      "atom sl' \<sharp> (s1,k1,s,k,x,x',v,i,m,n,sm,sm',sn,sn')"
      "atom m \<sharp> (s1,k1,s,k,x,x',v,i,n,sm,sm',sn,sn')" 
    ...
    apply (rule cut_same [OF exists_RestrictedP [of s s1 "SUCC k1"]])
     apply (rule AssumeH Ex_EH Conj_EH | simp)+
      ...
      apply (rule Conj_I)
       apply (blast intro: RestrictedP_LstSeqP_Eats [THEN cut2] SeqAbstFormP_imp_LstSeqP [THEN cut1])
  proof (rule All2_SUCC_I, simp_all)
    show "?hyp \<turnstile> SyntaxN.Ex sli
     (SyntaxN.Ex sl
       (SyntaxN.Ex sl'
...
theorem AbstFormP_Ex: "{AbstFormP v (SUCC i) x x'} \<turnstile> AbstFormP v i (Q_Ex x) (Q_Ex x')"
proof -
  obtain k1::name and s1::name and k::name and s::name
    where "atom s1 \<sharp> (v,i,x,x')"        "atom k1 \<sharp> (v,i,x,x',s1)"  
      "atom s  \<sharp> (v,i,x,x',k1,s1)"  "atom k  \<sharp> (v,i,x,x',s,k1,s1)" 
...
corollary AbstTermP_Var_same: "{VarP v, OrdP t} \<turnstile> AbstTermP v t v (Q_Ind t)"
proof -
  obtain s::name and k::name where "atom s \<sharp> (v,t,k)" "atom k \<sharp> (v,t)"
    by (metis obtain_fresh)
  thus ?thesis 
...
corollary AbstTermP_Var_diff: "{VarP v, VarP w, Neg (v EQ w), OrdP t} \<turnstile> AbstTermP v t w w"
proof -
  obtain s::name and k::name where "atom s \<sharp> (v,w,t,k)" "atom k \<sharp> (v,w,t)"
    by (metis obtain_fresh)
  thus ?thesis 
...
theorem AbstTermP_Eats:
   "{AbstTermP v i t1 u1, AbstTermP v i t2 u2} \<turnstile> AbstTermP v i (Q_Eats t1 t2) (Q_Eats u1 u2)"
proof -
  obtain k1::name and s1::name and k2::name and s2::name and k::name and s::name
    where "atom s1 \<sharp> (v,i,t1,u1,t2,u2)" "atom k1 \<sharp> (v,i,t1,u1,t2,u2,s1)"  
          "atom s2 \<sharp> (v,i,t1,u1,t2,u2,k1,s1)" "atom k2 \<sharp> (v,i,t1,u1,t2,u2,s2,k1,s1)"
...
corollary AbstTermP_Ind: "{VarP v, IndP w, OrdP t} \<turnstile> AbstTermP v t w w"
proof -
  obtain s::name and k::name where "atom s \<sharp> (v,w,t,k)" "atom k \<sharp> (v,w,t)"
    by (metis obtain_fresh)
  thus ?thesis 
...
lemma ORD_OF_EQ_diff: "x \<noteq> y \<Longrightarrow> {ORD_OF x EQ ORD_OF y} \<turnstile> Fls"
...
lemma AtomicP_Mem: 
  "{TermP x, TermP y} \<turnstile> AtomicP (Q_Mem x y)"
proof -
  obtain t::name and u::name
    where "atom t \<sharp> (x, y)" "atom u \<sharp> (t, x, y)"
    by (metis obtain_fresh) 
  thus ?thesis
...
lemma AtomicP_Eq: 
  "{TermP x, TermP y} \<turnstile> AtomicP (Q_Eq x y)"
proof -
  obtain t::name and u::name
    where "atom t \<sharp> (x, y)" "atom u \<sharp> (t, x, y)"
    by (metis obtain_fresh) 
...
lemma SeqFormP_Mem:
  ...
  shows "{TermP x, TermP y} \<turnstile> Ex k (Ex s (SeqFormP (Var s) (Var k) (Q_Mem x y)))"
proof -
  let ?vs = "(x,y,s,k)"
  obtain l::name and sl::name and m::name and n::name and sm::name and sn::name
    where
      "atom l \<sharp> (?vs,sl,m,n,sm,sn)"
      "atom sl \<sharp> (?vs,m,n,sm,sn)"
      "atom m \<sharp> (?vs,n,sm,sn)" "atom n \<sharp> (?vs,sm,sn)"
      "atom sm \<sharp> (?vs,sn)"
      "atom sn \<sharp> (?vs)"
    by (metis obtain_fresh) 
...
lemma FormP_Mem: 
  "{TermP x, TermP y} \<turnstile> FormP (Q_Mem x y)"
proof -
  obtain s::name and k::name
    where "atom s \<sharp> (x, y)" "atom k \<sharp> (s, x, y)"
    by (metis obtain_fresh)
  thus ?thesis
...
lemma FormP_Eq: 
  "{TermP x, TermP y} \<turnstile> FormP (Q_Eq x y)"
proof -
  obtain s::name and k::name
    where "atom s \<sharp> (x, y)" "atom k \<sharp> (s, x, y)"
    by (metis obtain_fresh)
...
proof -
  obtain a::name and b::name
    where "atom a \<sharp> (x, y)" "atom b \<sharp> (a, x, y)" by (metis obtain_fresh)
  then show ?thesis
    by (auto simp: MakeFormP.simps[of a _ _ _ b] intro: Disj_I2[OF Disj_I1])
qed

lemma MakeFormP_Disj: "{} \<turnstile> MakeFormP (Q_Disj x y) x y"
proof -
  obtain a::name and b::name
    where "atom a \<sharp> (x, y)" "atom b \<sharp> (a, x, y)" by (metis obtain_fresh)
  then show ?thesis
...
lemma MakeFormP_Ex: "{AbstFormP v Zero t x} \<turnstile> MakeFormP (Q_Ex x) t y"
proof -
  obtain a::name and b::name
    where "atom a \<sharp> (v, x, t, y)" "atom b \<sharp> (a, v, x, t, y)" by (metis obtain_fresh)
  then show ?thesis
...
lemma SeqFormP_Neg:
  ...
  shows "{SeqFormP s1 k1 x} \<turnstile> Ex k (Ex s (SeqFormP (Var s) (Var k) (Q_Neg x)))" (*<*)
proof -
  let ?vs = "(s1,k1,s,k,x)"
  ...
  proof (rule All2_SUCC_I, simp_all)
    show "?hyp \<turnstile> SyntaxN.Ex sn
  ...
  next
    show "?hyp \<turnstile> All2 n (SUCC k1)
     (SyntaxN.Ex sn
...
theorem FormP_Neg: "{FormP x} \<turnstile> FormP (Q_Neg x)"
proof -
  obtain k1::name and s1::name and k::name and s::name
    where "atom s1 \<sharp> x"        "atom k1 \<sharp> (x,s1)"  
      "atom s \<sharp> (x,k1,s1)"  "atom k  \<sharp> (x,s,k1,s1)" 
    by (metis obtain_fresh)
  thus ?thesis
...
lemma SeqFormP_Disj:
  ...
  shows "{SeqFormP s1 k1 x, SeqFormP s2 k2 y} 
           \<turnstile> Ex k (Ex s (SeqFormP (Var s) (Var k) (Q_Disj x y)))" (*<*)
proof -
  let ?vs = "(s1,s2,s,k1,k2,k,x,y)"
  obtain km::name and kn::name and j::name and k'::name 
    and l::name and sl::name and m::name and n::name  
    and sm::name and sn::name
    where atoms2: "atom km \<sharp> (kn,j,k',l,s1,s2,s,k1,k2,k,x,y,sl,m,n,sm,sn)"
      "atom kn \<sharp> (j,k',l,s1,s2,s,k1,k2,k,x,y,sl,m,n,sm,sn)"
      "atom j \<sharp> (k',l,s1,s2,s,k1,k2,k,x,y,sl,m,n,sm,sn)"
      and atoms: "atom k' \<sharp> (l,s1,s2,s,k1,k2,k,x,y,sl,m,n,sm,sn)" 
      "atom l \<sharp> (s1,s2,s,k1,k2,k,x,y,sl,m,n,sm,sn)"
      "atom sl \<sharp> (s1,s2,s,k1,k2,k,x,y,m,n,sm,sn)"
      "atom m \<sharp> (s1,s2,s,k1,k2,k,x,y,n,sm,sn)" 
      "atom n \<sharp> (s1,s2,s,k1,k2,k,x,y,sm,sn)"
      "atom sm \<sharp> (s1,s2,s,k1,k2,k,x,y,sn)"
      "atom sn \<sharp> (s1,s2,s,k1,k2,k,x,y)"
    by (metis obtain_fresh) 
  let ?hyp = "{HaddP k1 k2 (Var k'), OrdP k1, OrdP k2, SeqAppendP s1 (SUCC k1) s2 (SUCC k2) (Var s),
...
theorem FormP_Disj: 
  "{FormP x, FormP y} \<turnstile> FormP (Q_Disj x y)"
proof -
  obtain k1::name and s1::name and k2::name and s2::name and k::name and s::name
    where "atom s1 \<sharp> (x,y)"        "atom k1 \<sharp> (x,y,s1)"  
      "atom s2 \<sharp> (x,y,k1,s1)"  "atom k2 \<sharp> (x,y,s2,k1,s1)"
      "atom s  \<sharp> (x,y,k2,s2,k1,s1)" "atom k  \<sharp> (x,y,s,k2,s2,k1,s1)" 
    by (metis obtain_fresh)
  thus ?thesis
...
lemma SeqFormP_Ex:
  ...
  shows "{SeqFormP s1 k1 x,AbstFormP v Zero x y, VarP v} \<turnstile> Ex k (Ex s (SeqFormP (Var s) (Var k) (Q_Ex y)))"
proof -
  let ?vs = "(s1,s,k1,k,x,y,v)"
  obtain km::name and kn::name and j::name and k'::name 
    and l::name and sl::name and m::name and n::name  
    and sm::name and sn::name
    where atoms2: "atom km \<sharp> (kn,j,k',l,s1,s,k1,k,x,y,v,sl,m,n,sm,sn)"
      "atom kn \<sharp> (j,k',l,s1,s,k1,k,x,y,v,sl,m,n,sm,sn)"
      "atom j \<sharp> (k',l,s1,s,k1,k,x,y,v,sl,m,n,sm,sn)"
      and atoms: "atom k' \<sharp> (l,s1,s,k1,k,x,y,v,sl,m,n,sm,sn)"
      "atom l \<sharp> (s1,s,k1,k,x,y,v,sl,m,n,sm,sn)"
      "atom sl \<sharp> (s1,s,k1,k,x,y,v,m,n,sm,sn)"
      "atom m \<sharp> (s1,s,k1,k,x,y,v,n,sm,sn)" 
      "atom n \<sharp> (s1,s,k1,k,x,y,v,sm,sn)"
      "atom sm \<sharp> (s1,s,k1,k,x,y,v,sn)"
      "atom sn \<sharp> (s1,s,k1,k,x,y,v)"
    by (metis obtain_fresh)
...
lemma FormP_quot_dbfm:
  fixes A :: dbfm
  shows "wf_dbfm A \<Longrightarrow> {} \<turnstile> FormP (quot_dbfm A)"
...
lemma PfP_I:
  assumes "{} \<turnstile> PrfP S K A"
  shows "{} \<turnstile> PfP A"
proof -
  obtain s::name and k::name where "atom s \<sharp> (k,A,S,K)" "atom k \<sharp> (A,S,K)" by (metis obtain_fresh)
  with assms show ?thesis
...
proof -
  obtain x y z ::name where "atom x \<sharp> (y,z,j,w,A)" "atom y \<sharp> (z,j,w,A)"  "atom z \<sharp> (j,w,A)"
    by (metis obtain_fresh)
  thus ?thesis
...
next
  ...
  obtain l::name and sl::name and m::name and n::name and 
         ...
         where atoms:
          "atom l \<sharp> (x,y,z,sl,m,n,sm,sn)"
         "atom sl \<sharp> (x,y,z,m,n,sm,sn)"
          "atom m \<sharp> (x,y,z,n,sm,sn)"
          "atom n \<sharp> (x,y,z,sm,sn)"
         "atom sm \<sharp> (x,y,z,sn)"
         "atom sn \<sharp> (x,y,z)"
          "atom z \<sharp> (x,y)"
          "atom y \<sharp> x"
    by (metis obtain_fresh)
  ...
  from Spec atoms show ?case
    ...
    let ?vs' = "(?vs, X, i, t)"
      obtain AA XX ii tt res :: name
        where atoms:
          "atom AA \<sharp> (?vs', res, tt, ii, XX)"
          "atom XX \<sharp> (?vs', res, tt, ii)"
          "atom ii \<sharp> (?vs', res, tt)"
          "atom tt \<sharp> (?vs', res)"
          "atom res \<sharp> ?vs'"
        by (metis obtain_fresh)
      with I show ?thesis
  ...
  from Ind atoms show ?case
    ...
    using prems proof (cases A rule: induction_axioms.cases)
      ...
      obtain ax allvw allw xevw xw x0 xa w v :: name
        where atoms:
          "atom ax \<sharp> (?vs', v, w, xa, x0, xw, xevw, allw, allvw)"
          "atom allvw \<sharp> (?vs', v, w, xa, x0, xw, xevw, allw)"
          "atom allw \<sharp> (?vs', v, w, xa, x0, xw, xevw)"
          "atom xevw \<sharp> (?vs', v, w, xa, x0, xw)"
          "atom xw \<sharp> (?vs', v, w, xa, x0)"
          "atom x0 \<sharp> (?vs', v, w, xa)"
          "atom xa \<sharp> (?vs', v, w)"
          "atom w \<sharp> (?vs', v)"
          "atom v \<sharp> (?vs')"
        by (metis obtain_fresh)
