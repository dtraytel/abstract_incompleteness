...
text \<open> We prove Tarski's syntactic and semantic theorems about the non-definability
and respectively non-expressiveness of truth \<close>

(*<*)
theory Tarski
  imports Godel_Formula Standard_Model
begin 
(*>*)
...
end \<comment> \<open>context Godel_Form_prv_eq_isTrue\<close>
