section \<open>Rosser Formula\<close>

text \<open> The Rosser formula \<phi>R is a modification of the Godel formula that
is undecidable assuming consistency only (not \<omega>consistency)\<close>

(*<*)
theory Rosser_Formula
  imports Diagonalization Godel_Formula
begin  
(*>*)
...
text \<open> The Rosser modification of the Godel formula \<close>
